...
class Media extends \Ecommerce\EcommerceBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Media' . "\0" . 'alt');
        }
